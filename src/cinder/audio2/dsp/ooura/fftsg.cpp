...
#include "cinder/audio2/dsp/ooura/fftsg.h"
...
template <typename T> void bitrv2conj(int n, int *ip, T *a);
template <typename T> void bitrv216(T *a);
template <typename T> void bitrv216neg(T *a);
...
template <typename T> void cftf161(T *a, T *w);
template <typename T> void cftf162(T *a, T *w);
template <typename T> void cftf081(T *a, T *w);
template <typename T> void cftf082(T *a, T *w);
template <typename T> void cftb040(T *a);
template <typename T> void cftx020(T *a);
...
void cftf1st(int n, T *a, T *w)
{
    ...
    T wn4r, csc1, csc3, wk1r, wk1i, wk3r, wk3i,
           wd1r, wd1i, wd3r, wd3i;
